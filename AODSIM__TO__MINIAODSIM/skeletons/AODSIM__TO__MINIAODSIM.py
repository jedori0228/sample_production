...
# with command line options: step1 --filein file:AODSIM.root --fileout MINIAODSIM.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 94X_mc2017_realistic_v14 --step PAT --nThreads 4 --scenario pp --era Run2_2017,run2_miniAOD_94XFall17 --python_filename AODSIM__TO__MINIAODSIM.py --no_exec -n 4800
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:AODSIM.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('MINIAODSIM.root'),
