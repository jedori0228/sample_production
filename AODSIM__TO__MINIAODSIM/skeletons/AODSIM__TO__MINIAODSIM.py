...
# with command line options: step1 --filein file:AODSIM.root --fileout MINIAODSIM.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 94X_mc2017_realistic_v10 --step PAT --nThreads 8 --era Run2_2017 --python_filename AODSIM__TO__MINIAODSIM.py --no_exec -n 4800
