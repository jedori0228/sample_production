...
# with command line options: step1 --filein AODSIM.root --fileout MiniAOD.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step PAT --nThreads 4 --era Run2_2016 --python_filename AODSIM_to_MiniAOD.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 1920
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('AODSIM.root'),
