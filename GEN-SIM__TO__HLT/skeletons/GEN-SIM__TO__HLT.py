...
# with command line options: step1 --filein file:GEN-SIM.root --fileout HLT.root --pileup_input pu.root --mc --eventcontent PREMIXRAW --datatier GEN-SIM-RAW --conditions 94X_mc2017_realistic_v10 --step DIGIPREMIX_S2,DATAMIX,L1,DIGI2RAW,HLT:2e34v40 --nThreads 8 --datamix PreMix --era Run2_2017 --python_filename GEN-SIM__TO__HLT.py --no_exec -n 1751
