...
# with command line options: step1 --filein gensim.root --fileout RAWSIM.root --pileup_input MinBias.root --mc --eventcontent PREMIXRAW --datatier GEN-SIM-RAW --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step DIGIPREMIX_S2,DATAMIX,L1,DIGI2RAW,HLT:@frozen2016 --nThreads 4 --datamix PreMix --era Run2_2016 --python_filename SIM_to_RAWSIM.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 82
...
## input ##
filelist_inputLHE = sys.argv[2]
file_index = sys.argv[3]
inputfiles = open(filelist_inputLHE).readlines()
inputLHE= inputfiles[int(file_index)].strip('\n')
## MinBias ##
filelist_MinBias = sys.argv[4]
lines = open(filelist_MinBias).readlines()
total_pu_lines=-1
for line in lines:
 total_pu_lines+=1
pulists = []
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(inputLHE),
...
process.mixData.input.fileNames = cms.untracked.vstring(pulists)
