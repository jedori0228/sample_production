...
# with command line options: step2 --filein RAWSIM.root --fileout AODSIM.root --mc --eventcontent AODSIM --runUnscheduled --datatier AODSIM --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step RAW2DIGI,RECO --nThreads 4 --era Run2_2016 --python_filename RAWSIM_to_AODSIM.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 82
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('RAWSIM.root'),
